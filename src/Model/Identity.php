...
class Identity implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'identity';
    ...
    */
     ...
     * Sets display_name
     *
     * @param string $display_name The identity's display name. Note that this may not always be available or up to date. For example, if a user changes their display name, the API may show the new value in a future response, but the items associated with the user won't show up as having changed when using delta.
     *
     * @return $this
     */
     ...
     * Sets id
     *
     * @param string|null $id Unique identifier for the identity.
     *
     * @return $this
     */
