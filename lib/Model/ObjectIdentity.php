...
/**
 * ObjectIdentity Class Doc Comment
 *
 * @category Class
 ...
 */
class ObjectIdentity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'objectIdentity';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('issuer_assigned_id', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets issuer
     *
     * @param string|null $issuer domain of the Provider issuing the identity
     *
     * @return self
     */
     ...
     *
     * @param string|null $issuer_assigned_id The unique id assigned by the issuer to the account
     *
     * @return self
     */
    public function setIssuerAssignedId($issuer_assigned_id)
    {
        if (is_null($issuer_assigned_id)) {
            throw new \InvalidArgumentException('non-nullable issuer_assigned_id cannot be null');
        }
