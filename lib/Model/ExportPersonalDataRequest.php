...
/**
 * ExportPersonalDataRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExportPersonalDataRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExportPersonalData_request';
    ...
    */
     ...
     *
     * @param string|null $storage_location the path where the file should be created in the users personal space
     *
     * @return self
     */
