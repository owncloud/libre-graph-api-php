...
class Image implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets height
     *
     * @param int|null $height Optional. Height of the image, in pixels. Read-only.
     *
     * @return self
     */
    public function setHeight($height)
    {
        ...
        if (!is_null($height) && ($height > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $height when calling Image., must be smaller than or equal to 2147483647.');
        }
     ...
     * Sets width
     *
     * @param int|null $width Optional. Width of the image, in pixels. Read-only.
     *
     * @return self
     */
    public function setWidth($width)
    {
        ...
        if (!is_null($width) && ($width > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $width when calling Image., must be smaller than or equal to 2147483647.');
        }
