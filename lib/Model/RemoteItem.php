...
class RemoteItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setLastModifiedDateTime($last_modified_date_time)
    {
        ...
        if (!is_null($last_modified_date_time) && (!preg_match("/^[0-9]{4,}-(0[1-9]|1[012])-(0[1-9]|[12][0-9]|3[01])T([01][0-9]|2[0-3]):[0-5][0-9]:[0-5][0-9]([.][0-9]{1,12})?(Z|[+-][0-9][0-9]:[0-9][0-9])$/", $last_modified_date_time))) {
