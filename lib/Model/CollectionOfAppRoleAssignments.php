...
/**
 * CollectionOfAppRoleAssignments Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CollectionOfAppRoleAssignments implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Collection_of_appRoleAssignments';
    ...
    protected static $openAPITypes = [
        'value' => '\OpenAPI\Client\Model\AppRoleAssignment[]',
    ...
    */
     ...
     * Sets value
     *
     * @param \OpenAPI\Client\Model\AppRoleAssignment[]|null $value value
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if (!is_null($value) && (count($value) > 100)) {
            throw new \InvalidArgumentException('invalid value for $value when calling CollectionOfAppRoleAssignments., number of items must be less than or equal to 100.');
        }
     ...
     * @return string|null
     */
    public function getAtOdataNextLink()
    {
     ...
     * @return self
     */
    public function setAtOdataNextLink($at_odata_next_link)
    {
