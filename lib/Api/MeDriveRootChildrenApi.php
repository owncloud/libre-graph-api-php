...
/**
 * MeDriveRootChildrenApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
/**
     ...
     */
    public function homeGetChildren(string $contentType = self::contentTypes['homeGetChildren'][0])
    {
    ...
    /**
     * Operation homeGetChildrenWithHttpInfo
     *
     * Get children from drive
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['homeGetChildren'] to see the possible values for this operation
     ...
     */
    public function homeGetChildrenWithHttpInfo(string $contentType = self::contentTypes['homeGetChildren'][0])
    {
    ...
    /**
     * Operation homeGetChildrenAsync
     *
     * Get children from drive
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['homeGetChildren'] to see the possible values for this operation
     ...
     */
    public function homeGetChildrenAsync(string $contentType = self::contentTypes['homeGetChildren'][0])
    {
    ...
    /**
     * Operation homeGetChildrenAsyncWithHttpInfo
     *
     * Get children from drive
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['homeGetChildren'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function homeGetChildrenAsyncWithHttpInfo(string $contentType = self::contentTypes['homeGetChildren'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CollectionOfDriveItems';
        $request = $this->homeGetChildrenRequest($contentType);
     ...
     */
    public function homeGetChildrenRequest(string $contentType = self::contentTypes['homeGetChildren'][0])
    {
