...
/**
 * MeDriveRootApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
/**
     ...
     */
    public function homeGetRoot(string $contentType = self::contentTypes['homeGetRoot'][0])
    {
        list($response) = $this->homeGetRootWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation homeGetRootWithHttpInfo
     *
     * Get root from personal space
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['homeGetRoot'] to see the possible values for this operation
     ...
     */
    public function homeGetRootWithHttpInfo(string $contentType = self::contentTypes['homeGetRoot'][0])
    {
        $request = $this->homeGetRootRequest($contentType);
     ...
     */
    public function homeGetRootAsync(string $contentType = self::contentTypes['homeGetRoot'][0])
    {
        return $this->homeGetRootAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation homeGetRootAsyncWithHttpInfo
     *
     * Get root from personal space
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['homeGetRoot'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function homeGetRootAsyncWithHttpInfo(string $contentType = self::contentTypes['homeGetRoot'][0])
    {
        $returnType = '\OpenAPI\Client\Model\DriveItem';
        $request = $this->homeGetRootRequest($contentType);
     ...
     */
    public function homeGetRootRequest(string $contentType = self::contentTypes['homeGetRoot'][0])
    {
