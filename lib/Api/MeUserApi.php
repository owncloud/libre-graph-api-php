...
class MeUserApi
{
     ...
     */
    public function getOwnUser($expand = null)
    {
        list($response) = $this->getOwnUserWithHttpInfo($expand);
        return $response;
    }
     ...
     */
    public function getOwnUserWithHttpInfo($expand = null)
    {
        $request = $this->getOwnUserRequest($expand);
     ...
     */
    public function getOwnUserAsync($expand = null)
    {
        return $this->getOwnUserAsyncWithHttpInfo($expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOwnUserAsyncWithHttpInfo($expand = null)
    {
        $returnType = '\OpenAPI\Client\Model\User';
        $request = $this->getOwnUserRequest($expand);
     ...
     */
    public function getOwnUserRequest($expand = null)
    {
