...
/**
     ...
     * @return void
     */
    public function deleteUser($user_id, $if_match = null, string $contentType = self::contentTypes['deleteUser'][0])
    {
     ...
     */
    public function deleteUserWithHttpInfo($user_id, $if_match = null, string $contentType = self::contentTypes['deleteUser'][0])
    {
     ...
     */
    public function deleteUserAsync($user_id, $if_match = null, string $contentType = self::contentTypes['deleteUser'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteUserAsyncWithHttpInfo($user_id, $if_match = null, string $contentType = self::contentTypes['deleteUser'][0])
    {
        $returnType = '';
        $request = $this->deleteUserRequest($user_id, $if_match, $contentType);
     ...
     */
    public function deleteUserRequest($user_id, $if_match = null, string $contentType = self::contentTypes['deleteUser'][0])
    {
     ...
     *
     * @param  string $user_id key: id or name of user (required)
     * @param  \OpenAPI\Client\Model\ExportPersonalDataRequest $export_personal_data_request destination the file should be created at (optional)
     ...
     * @return void
     */
    public function exportPersonalData($user_id, $export_personal_data_request = null, string $contentType = self::contentTypes['exportPersonalData'][0])
    {
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function exportPersonalDataWithHttpInfo($user_id, $export_personal_data_request = null, string $contentType = self::contentTypes['exportPersonalData'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function exportPersonalDataAsync($user_id, $export_personal_data_request = null, string $contentType = self::contentTypes['exportPersonalData'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function exportPersonalDataAsyncWithHttpInfo($user_id, $export_personal_data_request = null, string $contentType = self::contentTypes['exportPersonalData'][0])
    {
        $returnType = '';
        $request = $this->exportPersonalDataRequest($user_id, $export_personal_data_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function exportPersonalDataRequest($user_id, $export_personal_data_request = null, string $contentType = self::contentTypes['exportPersonalData'][0])
    {
     ...
     */
    public function getUser($user_id, $select = null, $expand = null, string $contentType = self::contentTypes['getUser'][0])
    {
     ...
     */
    public function getUserWithHttpInfo($user_id, $select = null, $expand = null, string $contentType = self::contentTypes['getUser'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserAsync($user_id, $select = null, $expand = null, string $contentType = self::contentTypes['getUser'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserAsyncWithHttpInfo($user_id, $select = null, $expand = null, string $contentType = self::contentTypes['getUser'][0])
    {
        $returnType = '\OpenAPI\Client\Model\User';
        $request = $this->getUserRequest($user_id, $select, $expand, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getUserRequest($user_id, $select = null, $expand = null, string $contentType = self::contentTypes['getUser'][0])
    {
