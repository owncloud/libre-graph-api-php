...
class UserApi
{
     ...
     * @return void
     */
    public function deleteUser($user_id, $if_match = null)
    {
        $this->deleteUserWithHttpInfo($user_id, $if_match);
    }
     ...
     */
    public function deleteUserWithHttpInfo($user_id, $if_match = null)
    {
        $request = $this->deleteUserRequest($user_id, $if_match);
     ...
     */
    public function deleteUserAsync($user_id, $if_match = null)
    {
        return $this->deleteUserAsyncWithHttpInfo($user_id, $if_match)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteUserAsyncWithHttpInfo($user_id, $if_match = null)
    {
        $returnType = '';
        $request = $this->deleteUserRequest($user_id, $if_match);
     ...
     */
    public function deleteUserRequest($user_id, $if_match = null)
    {
     ...
     * @return void
     */
    public function exportPersonalData($user_id, $export_personal_data_request = null)
    {
        $this->exportPersonalDataWithHttpInfo($user_id, $export_personal_data_request);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function exportPersonalDataWithHttpInfo($user_id, $export_personal_data_request = null)
    {
        $request = $this->exportPersonalDataRequest($user_id, $export_personal_data_request);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function exportPersonalDataAsync($user_id, $export_personal_data_request = null)
    {
        return $this->exportPersonalDataAsyncWithHttpInfo($user_id, $export_personal_data_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function exportPersonalDataAsyncWithHttpInfo($user_id, $export_personal_data_request = null)
    {
        $returnType = '';
        $request = $this->exportPersonalDataRequest($user_id, $export_personal_data_request);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function exportPersonalDataRequest($user_id, $export_personal_data_request = null)
    {
        ...
        if (isset($export_personal_data_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($export_personal_data_request));
            } else {
     ...
     */
    public function getUser($user_id, $select = null, $expand = null)
    {
        list($response) = $this->getUserWithHttpInfo($user_id, $select, $expand);
        return $response;
    }
     ...
     */
    public function getUserWithHttpInfo($user_id, $select = null, $expand = null)
    {
        $request = $this->getUserRequest($user_id, $select, $expand);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserAsync($user_id, $select = null, $expand = null)
    {
        return $this->getUserAsyncWithHttpInfo($user_id, $select, $expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserAsyncWithHttpInfo($user_id, $select = null, $expand = null)
    {
        $returnType = '\OpenAPI\Client\Model\User';
        $request = $this->getUserRequest($user_id, $select, $expand);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getUserRequest($user_id, $select = null, $expand = null)
    {
