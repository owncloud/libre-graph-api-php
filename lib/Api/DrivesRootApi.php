...
class DrivesRootApi
{
     ...
     */
    public function getRoot($drive_id)
    {
        list($response) = $this->getRootWithHttpInfo($drive_id);
        return $response;
    }
     ...
     */
    public function getRootWithHttpInfo($drive_id)
    {
        $request = $this->getRootRequest($drive_id);
     ...
     */
    public function getRootAsync($drive_id)
    {
        return $this->getRootAsyncWithHttpInfo($drive_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRootAsyncWithHttpInfo($drive_id)
    {
        $returnType = '\OpenAPI\Client\Model\DriveItem';
        $request = $this->getRootRequest($drive_id);
     ...
     */
    public function getRootRequest($drive_id)
    {
