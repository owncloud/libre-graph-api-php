...
/**
     ...
     */
    public function getRoot($drive_id, string $contentType = self::contentTypes['getRoot'][0])
    {
     ...
     */
    public function getRootWithHttpInfo($drive_id, string $contentType = self::contentTypes['getRoot'][0])
    {
     ...
     */
    public function getRootAsync($drive_id, string $contentType = self::contentTypes['getRoot'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRootAsyncWithHttpInfo($drive_id, string $contentType = self::contentTypes['getRoot'][0])
    {
        $returnType = '\OpenAPI\Client\Model\DriveItem';
        $request = $this->getRootRequest($drive_id, $contentType);
     ...
     */
    public function getRootRequest($drive_id, string $contentType = self::contentTypes['getRoot'][0])
    {
